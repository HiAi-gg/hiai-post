...
const STYLE_TO_DALLE: Record<'realistic' | 'illustration' | 'abstract' | 'minimalist', 'natural' | 'vivid'> = {
  realistic: 'natural',
  illustration: 'vivid',
  abstract: 'vivid',
  minimalist: 'natural',
...
export const imageGenTool = createTool({
  id: 'image-gen',
  description: 'Generate images for social media posts via DALL·E 3 (falls back to placehold.co when OPENAI_API_KEY is unset)',
