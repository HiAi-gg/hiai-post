...
import { tenants, socialAccounts, posts, campaigns, postTemplates } from './schema.js';
  ...
  await db.insert(postTemplates).values([
    {
      ...
      aiPrompt: 'Write an exciting product launch post for {{product_name}}. Highlight key features: {{features}}. Make it engaging with appropriate emojis.',
    ...
    },
    {
      ...
      aiPrompt: 'Write a short, punchy promotional tweet for a {{discount}} discount on {{product_name}}. Keep under 280 chars.',
    ...
    },
    {
      ...
      platform: 'linkedin',
      contentText: 'At {{company_name}}, we believe in transparency. Here\'s a look behind the scenes of {{process}}...',
      aiPrompt: 'Write a professional LinkedIn post about behind-the-scenes at {{company_name}}, focusing on {{process}}. Be authentic and engaging.',
